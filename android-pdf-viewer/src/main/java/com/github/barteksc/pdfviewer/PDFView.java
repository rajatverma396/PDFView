...
public class PDFView extends RelativeLayout {
    ...
    public void setTextSelectionView(){
    PDocSelection  pDocSelection =new PDocSelection(getContext());
    ...
    public void clearSelection(boolean withEvent) {
        if (withEvent&&onSelection != null) {
    ...
    public void endSearch() {
        ...
        if(onSearch!=null){
            onSearch.onSearchEnd(searchRecords);
        }
        selectionPaintView.invalidate();
...
*/
   ...
   /* public ArrayList<RectF> mergeLineRects(List<RectF> selRects, RectF box) {
    ...
    public interface OnSelection {
        ...
        void onSearch(ArrayList<SearchRecord> arr, String key, int flag );
        void onSearchEnd(HashMap<Integer, SearchRecord> aar);
    }
}
